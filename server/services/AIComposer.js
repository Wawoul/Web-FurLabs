...
class AIComposer {
    ...
    buildPrompt() {
        ...
        return `Can you make this gartic phone image into a ${artStyle} anthro character with the background being ${background}. Keeping the design as close to the original as possible. Keep the pose and style as close as possible even if it looks strange and unproportional.`;
    }
